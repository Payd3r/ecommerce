...
-- Creato il: Mag 20, 2025 alle 07:54
...
--
-- Dump dei dati per la tabella `delivery_info`
--

INSERT INTO `delivery_info` (`id`, `user_id`, `name`, `surname`, `stato`, `citta`, `provincia`, `via`, `cap`, `numero_civico`) VALUES
(1, 2, 'Luca', 'Cattaneo', 'Italia', 'Carimate', 'CO', 'Via Airoldi', '22060', 13),
(2, 1, 'Andrea', 'Mauri', 'Italia', 'Monguzzo', 'CO', 'Via Parini', '22040', 6),
(3, 15, 'prova', 'prova', 'prova', 'prova', 'prova', 'via prova', '1', 1);
...
--
-- Dump dei dati per la tabella `extended_users`
--

INSERT INTO `extended_users` (`id_users`, `url_banner`, `bio`, `approved`, `alt_text`, `approved_at`) VALUES
(3, '/Media/banner/3-banner-1747474162208.png', 'avsvxczczxc vxcczxc vsdvsdv', 1, '', '2025-05-17 09:29:22'),
(6, '/Media/banner/6-banner-1747579447041.png', 'prova', 1, '', '2025-05-18 14:44:07'),
(15, '/Media/banner/15-banner-1747471934247.png', 'aaaaaaaaaaaaaaaaaaaaaaaa', 1, '', '2025-05-17 08:52:14'),
(38, '/Media/banner/38-banner-1747575401465.png', 'mi piace il pisello e i soldi', 1, '', '2025-05-18 13:36:41');
...
(17, 1, 12.00, 'accepted', '2025-05-17 09:43:14'),
(18, 1, 29.99, 'accepted', '2025-05-17 09:44:14'),
(19, 1, 29.99, 'accepted', '2025-05-17 09:44:49');
...
(8, 3, 'prova4', 'aaaaaaaaaaaaa', 12.00, 0, 110, 15, '2025-05-05 16:22:15'),
...
(10, 3, 'Test Product Artisan 1746650002173', 'Un prodotto creato dai test di integrazione artisan', 29.99, 0, 49, 15, '2025-05-07 20:33:22'),
...
(12, 3, 'Test Product Artisan 1746650046954', 'Un prodotto creato dai test di integrazione artisan', 29.99, 0, 49, 15, '2025-05-07 20:34:06'),
...
(10, 15, '/Media/profile/15/15-profile-1747471934217.png', NULL),
(11, 3, '/Media/profile/3/3-profile-1747474162178.png', NULL),
(12, 38, '/Media/profile/38/38-profile-1747575401431.png', NULL),
(13, 6, '/Media/profile/6/6-profile-1747579447013.png', NULL);
...
(1, 'andrea@gmail.com', '$2b$10$ZufCuMpuI/3s2sA2LnzgmOnBX/4BVUAfhOhdaXRzAIdLo1ZJnIaUC', 'Andreone', 'artisan', '2025-04-15 21:50:25'),
...
(6, 'mirko@gmail.com', '$2b$10$fosAGOCrmbEthpj0X4XElO9I.RTXdxCBgzR82IvRE.9LkwdwgwMBW', 'mirko', 'artisan', '2025-04-18 17:06:15'),
...
(15, 'prova@gmail.com', '$2b$10$MgIcCmRhnAwxtTPmsH5QJ.47o3BdsQaut/gwg9vBnYygGCZki6jFG', 'prova', 'artisan', '2025-04-20 19:28:40'),
...
(38, 'lucatest@gmail.com', '$2b$10$rd7fCmOXDEr2/hWLNHuS3ObicdjACwXwcQiG3banN2bUHk2.pRla2', 'luchinotesterino', 'artisan', '2025-05-18 13:33:07');
