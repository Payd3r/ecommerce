        ...
        list.innerHTML = artisans.map(artisan => {
            ...
            <div class="col-12 col-sm-6 col-lg-4 d-flex align-items-stretch">
                <div class="artisan-card card flex-fill shadow border-0 position-relative overflow-hidden my-2">
                    ${artisan.url_banner ?
                        `<div class='artisan-banner position-absolute top-0 start-0 w-100 h-100' style="background: url("${artisan.url_banner}') center/cover no-repeat; opacity: 0.22; z-index:1;"></div>`
                        : ''}
                    <div class="card-body text-center py-3 px-2 position-relative" style="z-index:2;">
                        <div class="artisan-profile-img mx-auto mb-2 position-relative d-flex justify-content-center align-items-center" style="width: 90px; height: 90px; border-radius: 50%; overflow: hidden; border: 3px solid #fff; box-shadow: 0 2px 8px rgba(0,0,0,0.13); background: #f8f9fa;">
                            ${artisan.image ?
