                            ...
                            <div id="categoryImagePreviewWrapper" class="mt-2">
                                ${imageUrl ? `
                                    <div style=\"position:relative; display:inline-block;\">
                                        <img src=\"http://localhost:3015${imageUrl}\" alt=\"img\" style=\"width:80px; height:80px; object-fit:cover; border-radius:8px; border:1.5px solid #e0e0e0;\" />
            ...
            try {
                ...
                if (mode === 'edit') {
                    ...
                    if (imageToDelete && category.images && category.images.length > 0) {
                        ...
                        await fetch(`http://localhost:3015/images/category/${category.id}`, {
                            method: 'DELETE',
