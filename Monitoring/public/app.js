...
function openImageModal(imageName, browser, testName) {
    ...
    modalImage.src = `https://api.panesalame.andrea-mauri.duckdns.org/api/test/screenshot/${browser}/${imageName}`;
                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body p-2">
                                            <div class="screenshot-container position-relative mb-2">
                                                <img src="https://api.panesalame.andrea-mauri.duckdns.org/api/test/screenshot/${browser}/${test.browser_results[browser].screenshot}" 
